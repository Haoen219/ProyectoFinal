...
public class TablaCustom extends javax.swing.JTable {
    ...
    private String[] columnNames = {"ID", "商品名称", "商品单价", "数量", "商品总共"};
        ...
        this.addMouseListener(new MouseAdapter() {
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                if ((e.isPopupTrigger() || e.getButton() == MouseEvent.BUTTON3) && e.getComponent() instanceof JTable) {
                    ...
                    JMenuItem editar = new JMenuItem("修改数量");
                    JMenuItem borrar = new JMenuItem("取消商品");
    ...
    public boolean customDialogEditar(int rowindex) {
        ...
        JLabel label = new JLabel("输入数量: ");
        panel.add(label);
        panel.add(textField);

        int option = showConfirmDialog(null, panel, "修改数量", JOptionPane.OK_CANCEL_OPTION);
