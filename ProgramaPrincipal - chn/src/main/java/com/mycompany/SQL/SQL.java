...
public class SQL {
    ...
    public static final String ARTICULOS_PRECIO_ALMACEN = "precio_almacen";
    public static final String ARTICULOS_PRECIO = "precio";
    public static final String ARTICULOS_ALMACEN = "nombre_almacen";
    ...
    public static String sql_tabla_articulo
            ...
            + "    " + ARTICULOS_PRECIO_ALMACEN + " DECIMAL,\n"
            + "    " + ARTICULOS_PRECIO + " DECIMAL,\n"
            + "    " + ARTICULOS_ALMACEN + " TEXT NOT NULL\n"
            + ");";
    ...
    public static String sql_insertar_articulo = "INSERT INTO " + NOMBRE_ARTICULOS + "(" + ARTICULOS_NOMBRE + "," + ARTICULOS_PRECIO_ALMACEN + "," + ARTICULOS_PRECIO + "," + ARTICULOS_ALMACEN + ", id) VALUES(?,?,?,?,?)";
    public static String sql_modificar_articulo = "UPDATE " + NOMBRE_ARTICULOS + " SET " + ARTICULOS_NOMBRE + " = ? , " + ARTICULOS_PRECIO_ALMACEN + " = ? , " + ARTICULOS_PRECIO + " = ? , " + ARTICULOS_ALMACEN + " = ? WHERE id = ?";
...
//    public static String sql_modificar_articulo = "UPDATE " + NOMBRE_ARTICULOS + " SET " + ARTICULOS_NOMBRE + " = ? , " + ARTICULOS_PRECIO + " = ? WHERE id = ?";
    ...
    public static String sql_leer_articulos_filtro
            ...
            + " WHERE LOWER(id) LIKE ? OR LOWER(" + ARTICULOS_NOMBRE + ") LIKE ? OR LOWER(" + ARTICULOS_ALMACEN + ") LIKE ?";
}
