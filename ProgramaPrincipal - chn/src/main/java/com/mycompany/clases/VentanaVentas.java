...
public class VentanaVentas extends javax.swing.JFrame {
    ...
    String[] columnNames = {"销售ID", "日期", "商品名称", "商品单价", "商品总共"};
        ...
        jTableVentas.addMouseListener(new MouseAdapter() {
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                if ((e.isPopupTrigger() || e.getButton() == MouseEvent.BUTTON3) && e.getComponent() instanceof JTable) {
                    ...
                    JMenuItem borrar = new JMenuItem("删除出售");
    ...
    private void initComponents() {
        ...
        jButtonBuscar.setText(org.openide.util.NbBundle.getMessage(VentanaVentas.class, "VentanaVentas.jButtonBuscar.text")); // NOI18N
